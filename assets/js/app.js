var TriviaGame = (function GameMaker() {
  ...
  function init(opts) {
    //DOM elements
    starterTile = document.querySelector(opts.starterTile);
    questionsTile = document.querySelector(opts.questionsTile);
    startBtn = document.querySelector(opts.startBtn);
    questionCount = document.querySelector(opts.questions);
    categories = document.querySelector(opts.categories);
